package com.api.test.framework.utils;
...
/**
 * Utility class to print {@code Object}s to string using reflection and recursion.
 */
public class PrintObject {
     ...
     * @see #print(Object, boolean, IdentityHashMap, int)
    ...
    public static String print(Object object) {
        return print(object, false, new IdentityHashMap<Object, Object>(), 0);
    }
     ...
     * @return a custom-formatted string representing the internal values of the parsed object
     */
    public static String print(Object object, boolean isIncludingStatics) {
        return print(object, isIncludingStatics, new IdentityHashMap<Object, Object>(), 1);
    }

    private static String print(Object object, boolean isIncludingStatics, IdentityHashMap<Object, Object> visitorMap, int tabCount) {
        if (object == null ||
        ...
        if (object instanceof CharSequence) {
            ...
            if (object.getClass().isArray()) {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    String dump        = print(arrayObject, isIncludingStatics, visitorMap, tabCount + 1);
                ...
                for (Entry<String, Field> entry : fieldMap.entrySet()) {
                    ...
                    try {
                        ...
                        dump                  = print(fieldObject, isIncludingStatics, visitorMap, tabCount + 1);
                    }
                    catch (Throwable e) {
